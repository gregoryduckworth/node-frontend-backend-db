...
const Profile = () => {
  const { firstName, lastName, email, dateOfBirth, isLoading, updateProfile } =
    useAuthStore();
  ...
  return (
    <AuthenticatedLayout
      breadcrumbs={[
        { label: t("profile.title"), href: "/profile", current: true },
      ]}
    >
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  type="date"
                  value={
                    formDateOfBirth ? formDateOfBirth.substring(0, 10) : ""
                  }
